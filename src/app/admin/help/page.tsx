              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">How do I approve teacher registrations?</h4>
                    <p className="text-slate-600 text-sm">
                      Go to the "Approvals" section in your admin dashboard to review and approve pending teacher registrations.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">How can I view department-wide attendance reports?</h4>
                    <p className="text-slate-600 text-sm">
                      Use the "Analytics" section to view comprehensive attendance reports for your department.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">How do I manage student and teacher accounts?</h4>
                    <p className="text-slate-600 text-sm">
                      Navigate to "Students" or "Teachers" sections to view, edit, or manage user accounts in your department.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">What if there are system-wide issues?</h4>
                    <p className="text-slate-600 text-sm">
                      Contact technical support immediately. As an admin, you have priority support for system-wide issues.
                    </p>
                  </div>
                </div>
              </CardContent>
