              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">How do I mark my attendance?</h4>
                    <p className="text-slate-600 text-sm">
                      Scan the QR code displayed by your teacher during class using the attendance scanner in your dashboard.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">Why can't I see my attendance data?</h4>
                    <p className="text-slate-600 text-sm">
                      Make sure your profile is complete with department and semester information. Contact support if the issue persists.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">How do I update my profile?</h4>
                    <p className="text-slate-600 text-sm">
                      Go to your profile page and update your information. Some changes may require admin approval.
                    </p>
                  </div>

                  <div className="p-4 bg-slate-50 rounded-lg">
                    <h4 className="font-medium text-slate-900 mb-2">What if I missed marking attendance?</h4>
                    <p className="text-slate-600 text-sm">
                      Contact your teacher or admin immediately. They may be able to mark your attendance manually if you were present.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-slate-600">QR Code Scanner</span>
                    <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
                      <CheckCircle className="h-3 w-3 mr-1" />
                      Operational
                    </Badge>
